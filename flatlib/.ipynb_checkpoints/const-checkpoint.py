...
LIST_FIXED_STARS = [
    ...
    STAR_ALDEBARAN, STAR_ALNILAM, STAR_ANTARES,  STAR_ALTAIR, STAR_DENEB_ALGEDI,
    STAR_FOMALHAUT, STAR_DENEB_ADIGE, STAR_ACHERNAR, STAR_CAPELLA,
    ...
    STAR_AGENA, STAR_RIGEL, STAR_RIGEL_CENTAURUS, STAR_RUKBAT, 
    STAR_MENKALINAN, STAR_LESATH, STAR_VEGA, 
]
