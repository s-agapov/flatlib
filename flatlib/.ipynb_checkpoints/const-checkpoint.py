...
LIST_FIXED_STARS = [
    ...
    STAR_ASELLUS_AUSTRALIS, STAR_ALPHARD, STAR_ALGORAB, STAR_ARCTURUS,
    STAR_ALPHECCA, STAR_BELLATRIX,  STAR_BETELGEUSE, STAR_CAPELLA,
    STAR_CANOPUS, STAR_CASTOR, STAR_DENEB_ALGEDI, STAR_DENEB_ADIGE, STAR_DENEBOLA,   
    STAR_FOMALHAUT,
    STAR_POLLUX, STAR_PROCYON,  STAR_REGULUS,
    STAR_UNUKALHAI,
    STAR_RIGEL, STAR_RIGEL_CENTAURUS, STAR_RUKBAT,   STAR_SIRIUS, STAR_SPICA, 
    STAR_MENKALINAN, STAR_LESATH, STAR_VEGA, STAR_ZUBEN_ELSCHEMALI,
]
